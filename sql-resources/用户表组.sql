...
CREATE TABLE user_info (
    ...
    head_pic VARCHAR(32) NOT NULL COMMENT '用户头像id',
...
CREATE Table user_head_info (
    id INT PRIMARY KEY AUTO_INCREMENT COMMENT '自增长id',
    uid VARCHAR(32) NOT NULL COMMENT '头像uid',
    head_path VARCHAR(256) NOT NULL DEFAULT '' COMMENT '头像路径',
    create_time DATETIME COMMENT '创建时间',
    update_time DATETIME COMMENT '修改时间'
) COMMENT '用户头像表' CHAR SET "utf8mb4";